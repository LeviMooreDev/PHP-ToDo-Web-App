...
Database::connect();
$result = Database::query("SELECT `id`, `title`, `subtitle`, `categories`, `authors`, `publishers`, `date`, `page`, `status`, `isbn13`, `isbn10`, `cover-color`, `update_timestamp`, `created_timestamp` as added FROM `book-hub`");
